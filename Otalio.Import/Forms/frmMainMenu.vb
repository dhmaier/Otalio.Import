...
#Region "Buttons"
  ...
  Private Sub bbiOpenWorkbook_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiOpenWorkbook.ItemClick
    ...
    If fd.ShowDialog() = DialogResult.OK Then
      ...
      If File.Exists(sFilename) Then
        ...
        Else
          MsgBox("Failed to load Data import workbook file")
        End If
  ...
  Private Sub bbiQuery_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiQuery.ItemClick
    ...
    If MsgBox("Running the query will remove all existing data from the excel worksheet.  Are you sure?", vbYesNoCancel) = vbYes Then
      Call QueryandLoad()
    End If
...
#Region "Functions"
  ...
  Public Function APICallEvent(psRequest As RestRequest, psResponse As IRestResponse)
    Try
  ...
  Public Function createNewExcelSheet()

    ValidateDataTempalte()

    If String.IsNullOrEmpty(UcProperties1._DataImportTemplate.WorkbookSheetName.ToString) = False Then
      ...
      With spreadsheetControl
        ...
        With .ActiveWorksheet
          For Each oImportColumn In UcProperties1._DataImportTemplate.ImportColumns.OrderBy(Function(n) n.ColumnID)
          ...
          For Each oValadation In UcProperties1._DataImportTemplate.Validators
  ...
  Private Sub ValidateDataTempalte()
    Try
      'extract list of columns from the Json code
      Dim oColumns As List(Of clsImportColum) = ExactExcelColumns(UcProperties1._DataImportTemplate.DTOObject).OrderBy(Function(n) n.No).ToList
      ...
      With UcProperties1._DataImportTemplate
      ...
      With oVariables
        If oVariables IsNot Nothing AndAlso .Count > 0 Then
          For Each oVariable As clsVariables In oVariables
            If UcProperties1._DataImportTemplate.Variables.Exists(Function(n) n.Name = oVariable.Name) = False Then
              .Add(oVariable)
            End If
          Next
        End If
      ...
      If UcProperties1._DataImportTemplate.Validators IsNot Nothing Then
        For Each oValidation As clsValidation In UcProperties1._DataImportTemplate.Validators
  ...
  Public Function ValidateData() As Boolean
    ...
    Try
      ...
      Dim oTemplate As clsDataImportTemplate = UcProperties1._DataImportTemplate
        ...
        If oTemplate.Validators IsNot Nothing AndAlso oTemplate.Validators.Count > 0 Then
          For Each oValidation In oTemplate.Validators.Where(Function(n) n.Enabled = "1").OrderBy(Function(n) n.Priority).ToList
            ...
            If oValidation IsNot Nothing Then
              ...
              Dim sTemplateDTO As String = UcProperties1._DataImportTemplate.DTOObject
              sTemplateDTO = Replace(sTemplateDTO, vbNewLine, "")

              'validate that the specified worksheet exists
              With spreadsheetControl
                If .Document.Worksheets.Contains(UcProperties1._DataImportTemplate.WorkbookSheetName) = False Then
                  MsgBox(String.Format("Cannot find worksheet {0}", UcProperties1._DataImportTemplate.WorkbookSheetName))
                  Return False
                Else
                  'if its found make it the active worksheet
                  .Document.Worksheets.ActiveWorksheet = .Document.Worksheets(UcProperties1._DataImportTemplate.WorkbookSheetName)
              ...
              If sColumns IsNot Nothing AndAlso sColumns.Count >= 0 Then
                ...
                With spreadsheetControl.ActiveWorksheet
                  ...
                  If bFormatted = False Then
                    .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusCodeColumn, 1)).Value = "Validation Code"
                    .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusDescirptionColumn, 1)).Value = "Validation Description"

                    Dim oRangeError As DevExpress.Spreadsheet.CellRange = .Range.FromLTRB(.Columns(UcProperties1._DataImportTemplate.StatusCodeColumn).Index, 1, .Columns(UcProperties1._DataImportTemplate.StatusCodeColumn).Index, nCountRows)
                    oRangeError.Value = ""
                    oRangeError = .Range.FromLTRB(.Columns(UcProperties1._DataImportTemplate.StatusDescirptionColumn).Index, 1, .Columns(UcProperties1._DataImportTemplate.StatusDescirptionColumn).Index, nCountRows)
                    oRangeError.Value = ""
      ...
      End If
      Call HideShowColumns(mbHideCalulationColumns)
    ...
    Try
      ...
      If goHTTPServer.TestConnection(True, UcConnectionDetails1._Connection) Then
        ...
        With spreadsheetControl.ActiveWorksheet
          ...
          .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusCodeColumn, 1)).Value = "Result Code"
          .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusDescirptionColumn, 1)).Value = "Result Description"
          ...
          For nRow = 2 To nCountRows + 1
            ...
            If .Rows.Item(nRow).Visible = True Then
              ...
              Dim sQuery As String = UcProperties1._DataImportTemplate.UpdateQuery.ToString
              ...
              If String.IsNullOrEmpty(UcProperties1._DataImportTemplate.ReturnCellDTO) = False Then
                .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.ReturnCellDTO, nRow)).Value = oDTO.ToString
              End If

              Dim oResponse As IRestResponse

              Select Case UcProperties1._DataImportTemplate.ImportType
                Case "1"
                  oResponse = goHTTPServer.CallWebEndpointUsingPost(UcProperties1._DataImportTemplate.APIEndpoint, oDTO)
                Case "2"
                  If String.IsNullOrEmpty(.Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.ReturnCell, nRow)).Value.ToString) Then
                    'add
                    oResponse = goHTTPServer.CallWebEndpointUsingPost(UcProperties1._DataImportTemplate.APIEndpoint, oDTO)
                  Else
                    'edit
                    oResponse = goHTTPServer.CallWebEndpointUsingPut(UcProperties1._DataImportTemplate.APIEndpoint,
                                                                   .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.ReturnCell, nRow)).Value.ToString,
                                                                    sQuery, oDTO)
                  End If
                Case Else
                  Exit Sub
              ...
              Select Case oResponse.StatusCode
                ...
                Case HttpStatusCode.Created, HttpStatusCode.OK
                  ...
                  Dim json As JObject = JObject.Parse(oResponse.Content)
                  .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusCodeColumn, nRow)).Value = oResponse.StatusCode.ToString
                  .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusDescirptionColumn, nRow)).Value = json.SelectToken("message").ToString

                  If String.IsNullOrEmpty(UcProperties1._DataImportTemplate.ReturnNodeValue.ToString) = False Then
                    ' If json.ContainsKey(UcProperties1._DataImportTemplate.ReturnNodeValue) Then
                    .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.ReturnCell, nRow)).Value = json.SelectToken(UcProperties1._DataImportTemplate.ReturnNodeValue).ToString
                    'End If
                  End If
                ...
                Case HttpStatusCode.NotFound
                  .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusCodeColumn, nRow)).Value = oResponse.StatusCode.ToString
                  .Cells(String.Format("{0}{1}", UcProperties1._DataImportTemplate.StatusDescirptionColumn, nRow)).Value = "Record not Found"
              ...
              If oResponse.StatusCode = HttpStatusCode.OK Then
                ...
                If oObject IsNot Nothing Then
                  If oObject.Count > 0 Then
                    ...
                    For Each oValidation As clsValidation In UcProperties1._DataImportTemplate.Validators.Where(Function(n) n.Enabled = "1" Or n.Visibility = "1").ToList
                          ...
                          Select Case oValidation.ValidationType
                            ...
                            Case "1", "5" 'FindAndReplace
                              ...
                              Try
                                ...
                                sQuery = Replace(sQuery, sDataSource, Replace(oValidation.ReturnNodeValue, "responsePayload.content[0].", ""))

                                Dim oReturnNode As String = String.Format("responsePayload.content[0].{0}", sDataSource)
                                  ...
                                  If String.IsNullOrEmpty(.ActiveWorksheet.Cells(String.Format("{0}{1}", sKey, nRow)).Value.ToString) = True Then
                                    ...
                                    If .ActiveWorksheet.Cells(String.Format("{0}{1}", oValidation.ReturnCell, nRow)).Value IsNot Nothing AndAlso
                                     String.IsNullOrEmpty(.ActiveWorksheet.Cells(String.Format("{0}{1}", oValidation.ReturnCell, nRow)).Value.ToString) = False Then
                                      ...
                                      Else
                                        sValue = goHTTPServer.GetValueFromEndpoint(sAPIendpoint, sNewQuery, oReturnNode)
  ...
  Private Sub HideShowColumns(psHide As Boolean)
    Try
